    ...
    uploadCover: function uploadCover() {var _this2 = this;
      ...
      then(function (res) {
        ...
        then(function (res) {
          ...
          wx.cloud.
          uploadFile({
            cloudPath: "userCover/".concat(openid, "_cover_").concat(time, ".jpg"),
          ...
          then( /*#__PURE__*/function () {var _ref3 = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee4(res) {return _regenerator.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:
                      ...
                      console.log(res);if (!(
                      res.errMsg === "cloud.uploadFile:ok")) {_context4.next = 5;break;}_context4.next = 5;return (
                        wx.cloud.
                        callFunction({
                          name: 'update',
                          data: {
                        ...
                        then(function (res) {
                          console.log(res);
                          uni.hideLoading();
                        }));case 5:case "end":return _context4.stop();}}}, _callee4);}));return function (_x3) {return _ref3.apply(this, arguments);};}());
